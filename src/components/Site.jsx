...
//     setXAxis(e.clientX - window.innerWidth / 2);
//     setYAxis(e.clientY - window.innerHeight / 2);

//     layers.forEach((el) => {
//       let speedx = el.dataset.speedx;
//       let speedy = el.dataset.speedy;
//       el.style.transform = `translate(calc(-50% + ${-xAxis * speedx}px), calc(-50% + ${-yAxis * speedy}px))`
//     })
//   })
//   return (
//     <Transition>
//       <div className="site-info">
//         <div className="rajgad-container">
//           <img src="/try/rajgad02.png" data-speedy="0.08" data-speedx="0.08" alt="" className="parallax bg-main" />
//           <div className="text"
...
//             <h1>Fort</h1>
//           </div>
//           <img src="/try/rajgad01.png"  data-speedy="0.03" data-speedx="0.02" alt="" className="parallax fort" />
//         </div>
//       </div>
